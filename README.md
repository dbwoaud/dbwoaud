...
**Tools & Others**
<img src="https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white"/> <img src="https://img.shields.io/badge/Visual_Studio-5C2D91?style=flat-square&logo=visual-studio&logoColor=white"/>
...
* **Architecture**: SOLID 원칙을 준수한 매니저 패턴 설계 활용.
* **Event-based System**: C# Action과 ScriptableObject를 결합하여 시스템 간 의존성을 낮춘 데이터 주도 설계.
* **Optimization**: 게임에 필요한 데이터에 적합한 자료구조를 직접 구현하여 유니티 내장 기능보다 최적화.
